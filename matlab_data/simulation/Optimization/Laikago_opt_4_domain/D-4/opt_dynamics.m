function [COP,F_c]= opt_dynamics(s,q_sol,dq_sol,Alpha,foot_index)
%%
 [D,c_vec,B] = opt_dynamics_laikago_matrix(q_sol,dq_sol);
    ...
    u=opt_feedback_linearization(s,q_sol,dq_sol,D,c_overall,B_overall,Alpha,foot_index); % Recheck it
