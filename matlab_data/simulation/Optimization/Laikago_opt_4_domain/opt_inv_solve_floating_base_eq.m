function [q_error,COP_,q_sol_whole_step,Fr,dq_sol_whole_step,phi_overall]...
    =opt_inv_solve_floating_base_eq(options,Alpha,foot_index,q0,StanceFeet)
...
% % %     
    ...
    for s=linspace(0,1,num_points)
        ...
        phi = [q1;ph;StanceFeet]-[-base_offset; 0; 0; 0; 0; 0; 0 ; zeros(11,1)]; %Desired value
        phi_overall(i,:) = phi';
       ...
       % deviation(i,1) =dev;
        ...
        [COP1,Fr1] = opt_dynamics(s,q_sol,dq_sol,Alpha,foot_index,StanceFeet);
