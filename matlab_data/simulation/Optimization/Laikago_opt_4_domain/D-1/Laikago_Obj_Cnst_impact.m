...
%% cost function 
    function J = obj(Alpha1)
      ...
      [q_error_1,COP_1,q_sol_whole_step_1,Fr,dq_sol,~]...
...
%%    foot_index 1
    ...
    %% unilateral constraints
        %Fr= Fr_1;
        C_grf_1 = -[Fr_1(3:48,3);Fr_1(3:48,6);Fr_1(3:48,9)];% A step (s=0 to 1) is devided into 50 substeps
        %C_grf_1 = [];
    %% pelvis pose
...
%     %% unilateral constraints
%         %Fr= Fr_2;
%         C_grf_2 = -[Fr_2(6:44,3);Fr_2(6:44,6);Fr_2(6:44,9)];% A step (s=0 to 1) is devided into 50 substeps    
%     
% %% pelvis pose
...
%        c_eq_dy_1 = dq_plus_2-dq_sol_whole_step_2(1,:)';
...
%        %% y invariance
       ...
       C2_ceq =[C2_ceq_1];               %[C1_ceq; C8_ceq1;zmp_ceq1;zmp_ceq2];
       C1_c = [C1_c_1]; %[C_grf; C2_c1;C6_c1;C8_c1;zmp_c1];
