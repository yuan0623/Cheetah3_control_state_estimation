...
%% cost function 
    function J = obj(Alpha)
        ...
        Optimized_2 = 0; Optimized_3 = 0; Optimized_4 = 0;
        [alp1, alp2] = bezier_coefficiet(Optimized_1, Optimized_2, Optimized_3, Optimized_4, 1);% used foot index =1 for transition from D-1 to D-2
        Alpha(1:7:50)=alp1;
        Alpha(2:7:51)=alp2;
...
%% constraints
 ...
 %% Making first two Bezier coefficient constant
load optimized_D1.mat optimized_variable
Optimized_1 = optimized_variable;
Optimized_2 = 0; Optimized_3 = 0; Optimized_4 = 0;
[alp1, alp2] = bezier_coefficiet(Optimized_1, Optimized_2, Optimized_3, Optimized_4, 1); % used foot index =1 for transition from D-1 to D-2
...
%% pelvis pose
        ...
        C8_c_12 = [Alpha82(2)-0.02,-Alpha82(3:5)+0.05, Alpha82(6)-0.02]';% Swing foot above the the ground        
%%
...
%     %% unilateral constraints
%         %Fr= Fr_3;
%         C_grf_3 = -[Fr_3(6:44,3);Fr_3(6:44,6);Fr_3(6:44,9)];% A step (s=0 to 1) is devided into 50 substeps    
%     
% %% pelvis pose
...
%        foot_index = 2;
%        dq_plus_3 = resetmap(x_minus_2,1);
       
%       c_eq_dy_2 = dq_plus_3-dq_sol_whole_step_2(1,:)';
...
%        
%        c_eq_dy_3 = dq_plus_4-dq_sol_whole_step_3(1,:)';
%        
...
%        c_eq_dy_4 = dq_plus_1-dq_sol_whole_step_4(1,:)';     
       ...
       C2_ceq =[C2_ceq_2];%c_eq_y_1;c_eq_dy_1];               %[C1_ceq; C8_ceq1;zmp_ceq1;zmp_ceq2];
       C1_c = [C1_c_2]; %[C_grf; C2_c1;C6_c1;C8_c1;zmp_c1];
