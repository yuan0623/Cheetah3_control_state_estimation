...
Alpha = optimized_variable(57:112); %Alpha;
load optimized_D1.mat
Optimized_1 = optimized_variable;
Optimized_2 = 0; Optimized_3 = 0; Optimized_4 = 0;
[alp1, alp2] = bezier_coefficiet(Optimized_1, Optimized_2, Optimized_3, Optimized_4, foot_index);
Alpha(1:7:50)=alp1;
Alpha(2:7:51)=alp2;
...
[optimized_D2,fval,exitflag,output] = fmincon(Cost,Alpha,A,b,Aeq,beq,...
    lb,ub,Cnst,options);
