function [u,s,uc,uv,ucm]=feedback_linearization(t,x,D,c_overall,B_overall,foot_index,Alpha,current_stance_foot_position,t_end_of_previous_step)
    ...
    global y_global dy_global  step_no offset t_global total_steps
...
%         %phi(12)=0.1;
    ...
    elseif want_bezier==1
        ...
        if foot_index == 1
            ...
            theta_minus = (Alpha1(42)-StanceFeet(1)+v_tm*0.5)/4;
...
%             theta;
        ...
        elseif foot_index == 2
            ...
            theta_minus = (Alpha1(42)-StanceFeet(7)+v_tm*0.5)/4;  
...
%theta = v_tm*(t_current-t_end_of_previous_step)+theta_plus;%q1 + theta_plus -step_no*0.1013;
   
theta = v_tm*(t_current-total_steps*0.5)+theta_plus;
...
%     Kd=24.9985*eye(9,9);
% 
%             Kp(1,1)=163.07;Kp(4,4)=163.07;Kp(7,7)=163.07;
%             Kd(1,1)=6.2720;Kd(4,4)=6.2720;Kd(7,7)=6.2720;
