...
% current_stance_foot_position = SF_dynamic;
    ...
    if foot_index == 1 % FL foot is swing foot
        ...
        jj_c = jj_1_func(q,dq);
            ...
            l1=0.1792-v_tm*t_global(end) +0.16*step_no; %FL
            l2= -0.2595-v_tm*t_global(end) +0.16*step_no;%RR
            l3= 0.2567-v_tm*t_global(end) +0.16*step_no;%FR
            l4= -0.1820-v_tm*t_global(end) +0.16*step_no; %RL     
    ...
    elseif foot_index == 2 % RR foot is swing foot
        ...
        jj_c = jj_2_func(q,dq);
            ...
            l1= 0.1792-v_tm*t_global(end)+ step_length +0.16*step_no; %FL
            l2= -0.2595-v_tm*t_global(end) +0.16*step_no;%RR
            l3= 0.2567-v_tm*t_global(end)+0.16*step_no;%FR
            l4= -0.1820-v_tm*t_global(end)+0.16*step_no; %RL  
    ...
    elseif foot_index == 3 % FR foot is swing foot
        ...
        jj_c = jj_3_func(q,dq);  
            ...
            l1= 0.1792-v_tm*t_global(end) + step_length +0.16*step_no; %FL
            l2= -0.2595-v_tm*t_global(end) + step_length +0.16*step_no;%RR
            l3= 0.2567-v_tm*t_global(end) +0.16*step_no;%FR
            l4= -0.1820-v_tm*t_global(end) +0.16*step_no; %RL        
    ...
    elseif foot_index == 4 % RR foot is swing foot
        ...
        jj_c = jj_4_func(q,dq);  
            ...
            l1= 0.1792-v_tm*t_global(end) + step_length +0.16*step_no; %FL
            l2= -0.2595-v_tm*t_global(end) + step_length +0.16*step_no;%RR
            l3= 0.2567- v_tm*t_global(end) + step_length +0.16*step_no;%FR
            l4= -0.1820-v_tm*t_global(end)+0.16*step_no; %RL        
