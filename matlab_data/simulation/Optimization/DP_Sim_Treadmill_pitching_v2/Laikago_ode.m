...
clear all
tic
global s_overall y_global dy_global t_global global_position_reference Fr COP s_global dphi_global phi_global hc_global step_no offset torque total_steps
...
v_contact_base=[-0.1000;0;0.1105;-0.1000;0;-0.1022;-0.1000;0;-0.1293];% obtained from optimization code
...
load Alpha_initial_s16_h09_sp.mat %IBC_pp_s16_h06_v5.mat IBC_pp_s16_h09_v1r2.mat
alpha = initial_guess;%Alpha_initial;
