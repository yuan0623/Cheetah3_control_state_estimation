...
%% cost function 
  ...
  Alpha54(7) = Alpha51(1);
      ...
      q0_1=[0, 0, 0.3292, 1.5708, 0, 1.5708, 0.1, 0, -0.8, 0.0965, 0.112, -0.72, 0.1,0, -0.8, 0.1, -0.14,-0.822]';%on the go pose
      t0_1=0;
      foot_index = 1;
    ...
    %%    
       J = c_eq_dy_1 + c_eq_dy_2 + c_eq_dy_3 + c_eq_dy_4;
       aa=J-8;
       aa;
...
%%    foot_index 1
 ...
 tc= floor(num_time_step/6);
    ...
    %% pelvis pose
        ...
        C2_c_11 = [Alpha21-0.5*ones(1,7),-Alpha21+0.18*ones(1,7)]'; %pelvis z coordinate is between 0.3 to 0.4m
        
        %% swing foot trave direction
        %Alpha61 is Coefficient for x-coordinate of swing leg
        C6_c_11 = [Alpha61-0.35,-Alpha61-0.10]';
        ...
        C8_ceq_11 = [Alpha81(1)-zp_0*sin(w*time_1(1)); Alpha81(end)-zp_0*sin(w*time_1(end))]; %Swing foot touches the ground at start and end
        C8_c_11 = [Alpha81(2)-zp_0*sin(w*time_1(tc))-0.01,-Alpha81(4)+zp_0*sin(w*time_1(3*tc))+0.03, Alpha81(6)-zp_0*sin(w*time_1(5*tc))-0.01]';% Swing foot above the the ground
%%
...
%% pelvis pose
        ...
        C2_c_12 = [Alpha22-0.5*ones(1,7),-Alpha22+0.18*ones(1,7)]'; %pelvis z coordinate is between 0.3 to 0.4m
        
        %% swing foot trave direction
        %Alpha62 is Coefficient for x-coordinate of swing leg
        C6_c_12 = [Alpha62+0.05,-Alpha62-0.3]';
        
        %% swing foot above the ground
        %Alpha82 is Coefficient for z-coordinate of swing leg
        C8_ceq_12 = [Alpha82(1)-zp_0*sin(w*time_2(1)); Alpha82(end)-zp_0*sin(w*time_2(end))]; %Swing foot touches the ground at start and end
        C8_c_12 = [Alpha82(2)-zp_0*sin(w*time_2(tc))-0.01,-Alpha82(4)+zp_0*sin(w*time_2(3*tc))+0.03, Alpha82(6)-zp_0*sin(w*time_2(5*tc))-0.01]';% Swing foot above the the ground        
%%
...
%% pelvis pose
        ...
        C2_c_13 = [Alpha23-0.5*ones(1,7),-Alpha23+0.18*ones(1,7)]'; %pelvis z coordinate is between 0.3 to 0.4m
        
        %% swing foot trave direction
        %Alpha63 is Coefficient for x-coordinate of swing leg
        C6_c_13 = [Alpha63-0.35,-Alpha63+0.15]';
        
        %% swing foot above the ground
        %Alpha83 is Coefficient for z-coordinate of swing leg
        C8_ceq_13 = [Alpha83(1)-zp_0*sin(w*time_3(1)); Alpha83(end)-zp_0*sin(w*time_3(end))]; %Swing foot touches the ground at start and end
        C8_c_13 = [Alpha83(2)-zp_0*sin(w*time_3(tc))-0.01,-Alpha83(4)+zp_0*sin(w*time_3(3*tc))+0.03, Alpha83(6)-zp_0*sin(w*time_3(5*tc))-0.01]';% Swing foot above the the ground       
%%
...
%% pelvis pose
        ...
        C2_c_14 = [Alpha24-0.5*ones(1,7),-Alpha24+0.18*ones(1,7)]'; %pelvis z coordinate is between 0.3 to 0.4m
        ...
        C8_ceq_14 = [Alpha84(1)-zp_0*sin(w*time_4(1)); Alpha84(end)-zp_0*sin(w*time_4(end))]; %Swing foot touches the ground at start and end
        C8_c_14 = [Alpha84(2)-zp_0*sin(w*time_4(tc))-0.01,-Alpha84(4)+zp_0*sin(w*time_4(3*tc))+0.03, Alpha84(6)-zp_0*sin(w*time_4(5*tc))-0.01]';% Swing foot above the the ground       
        %% 
       ...
       C2_ceq =[C2_ceq_1; C2_ceq_2;C2_ceq_3;C2_ceq_4];               %[C1_ceq; C8_ceq1;zmp_ceq1;zmp_ceq2];
