...
%% cost function 
  ...
  Alpha54(7) = Alpha51(1);
      ...
      [q_error_1,COP_1,q_sol_whole_step_1,Fr_1,dq_sol_whole_step_1,~,time_1,u_1]...
      ...
      foot_index = 2;
      [q_error_2,COP_2,q_sol_whole_step_2,Fr_2,dq_sol_whole_step_2,~,time_2,u_2]...
      ...
      foot_index = 3;
      [q_error_3,COP_3,q_sol_whole_step_3,Fr_3,dq_sol_whole_step_3,~,time_3,u_3]...
      ...
      foot_index = 4;
      [q_error_4,COP_4,q_sol_whole_step_4,Fr_4,dq_sol_whole_step_4,~,time_4,u_4]...
...
%%    foot_index 1
 ...
 tc= floor(num_time_step/6);
    ...
    %% pelvis pose
        ...
        C6_c_11 = [Alpha61-0.4,-Alpha61-0.10]';
...
%% pelvis pose
        ...
        C6_c_12 = [Alpha62+0.1,-Alpha62-0.35]';
...
%% pelvis pose
        ...
        C6_c_13 = [Alpha63-0.4,-Alpha63+0.10]';
...
%% pelvis pose
        ...
        C6_c_14 = [Alpha64+0.1,-Alpha64-0.35]';
