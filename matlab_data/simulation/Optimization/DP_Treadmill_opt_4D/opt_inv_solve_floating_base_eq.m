function [q_error,COP_,q_sol_whole_step,Fr,dq_sol_whole_step,phi_overall,time,u_ref]...
...
% % % F_4 = [FLFoot;FRFoot;RRFoot];[l1,l3,l2]
    ...
    for s=linspace(0,1,num_points)
        ...
        if foot_index==1
            ...
            l1r=0.2092-v_tm*t_ref; %FL
            l2r= -0.2295-v_tm*t_ref;%RR
            l3r= 0.2506-v_tm*t_ref;%FR
            l4r= -0.1881-v_tm*t_ref; %RL
            
            l1=0.2092-v_tm*t_inst; %FL
            l2= -0.2295-v_tm*t_inst;%RR
            l3= 0.2506-v_tm*t_inst;%FR
            l4= -0.1881-v_tm*t_inst; %RL
        ...
        elseif foot_index==2
            ...
            l1r= 0.2092-v_tm*t_ref + step_length; %FL
            l2r= -0.2295-v_tm*t_ref;%RR
            l3r= 0.2506-v_tm*t_ref;%FR
            l4r= -0.1881-v_tm*t_ref; %RL            
            
            l1= 0.2092-v_tm*t_inst + step_length; %FL
            l2= -0.2295-v_tm*t_inst;%RR
            l3= 0.2506-v_tm*t_inst;%FR
            l4= -0.1881-v_tm*t_inst; %RL
        ...
        elseif foot_index==3
            ...
            l1r= 0.2092-v_tm*t_ref + step_length; %FL
            l2r= -0.2295-v_tm*t_ref + step_length;%RR
            l3r= 0.2506-v_tm*t_ref;%FR
            l4r= -0.1881-v_tm*t_ref; %RL
            
            l1= 0.2092-v_tm*t_inst + step_length; %FL
            l2= -0.2295-v_tm*t_inst + step_length;%RR
            l3= 0.2506-v_tm*t_inst;%FR
            l4= -0.1881-v_tm*t_inst; %RL
        ...
        elseif foot_index==4
            ...
            l1r= 0.2092-v_tm*t_ref + step_length; %FL
            l2r= -0.2295-v_tm*t_ref + step_length;%RR
            l3r= 0.2506- v_tm*t_ref + step_length;%FR
            l4r= -0.1881-v_tm*t_ref; %RL            
            
            l1= 0.2092-v_tm*t_inst + step_length; %FL
            l2= -0.2295-v_tm*t_inst + step_length;%RR
            l3= 0.2506- v_tm*t_inst + step_length;%FR
            l4= -0.1881-v_tm*t_inst; %RL
...
%         StanceFeet;
        ...
        [COP1,Fr1,u] = opt_dynamics(s,q_sol,dq_sol,Alpha,foot_index,StanceFeet,t_inst);
