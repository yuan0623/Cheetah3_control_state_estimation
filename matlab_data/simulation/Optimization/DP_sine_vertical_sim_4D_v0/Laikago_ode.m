...
q0=[0.0, 0, 0.3292, 1.5708, 0, 1.5708, 0.1, 0, -0.8, 0.1, 0.11, -0.715, 0.1,0, -0.8, 0.1, -0.14,-0.72]';%on the go pose -0.821
x0(1:18)=q0;
j_c = j_1_func(q0);
...
% x0(19)=0.1;
% x0(21)=0.625;
dq0=j_contact_base\v_contact_base;
x0(19:36)=dq0;
