...
% [1,3,4],[2,4,1],[3,1,2],[4,2,3]%(1,3,4)(1,4,2)(1,3,2)(3,4,2)
    ...
    if foot_index == 1
        ...
        reset_jacobian = j_2_func(q); %Reset_j_1_func(q); %swing foot+the other two feet which  
            ...
            l1=0.1792-v_tm*t_e+step_length; %FL
            l2= -0.2595-v_tm*t_e;%RR
            l3= 0.2567-v_tm*t_e;%FR
            l4= -0.1820-v_tm*t_e; %RL
    ...
    elseif foot_index == 2
        ...
        reset_jacobian = j_3_func(q); %Reset_j_2_func(q);
            ...
            l1= 0.1792-v_tm*t_e+ step_length  ; %FL
            l2= -0.2595-v_tm*t_e+step_length  ;%RR
            l3= 0.2567-v_tm*t_e ;%FR
            l4= -0.1820-v_tm*t_e ; %RL
    ...
    elseif foot_index == 3
        ...
        reset_jacobian = j_4_func(q); %Reset_j_3_func(q);
            ...
            l1= 0.1792-v_tm*t_e + step_length; %FL
            l2= -0.2595-v_tm*t_e + step_length;%RR
            l3= 0.2567-v_tm*t_e + step_length;%FR
            l4= -0.1820-v_tm*t_e; %RL
    ...
    elseif foot_index == 4
        ...
        reset_jacobian = j_1_func(q);%Reset_j_4_func(q);
            ...
            l2= -0.2595-v_tm*t_e + step_length  ;%RR
            l3= 0.2567- v_tm*t_e + step_length  ;%FR
            l4= -0.1820-v_tm*t_e+ step_length ; %RL
